"""
Django settings for Luuna project.
...
SECRET_KEY = 'django-insecure-2s9%%)diy17-7j^-4dy1vjv1akcy@dfys7_x!m(_yd=(km!*du'
...
WSGI_APPLICATION = 'Luuna.wsgi.application'
